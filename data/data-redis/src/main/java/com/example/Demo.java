...
import com.example.services.SlowService;
...
@Component
public final class Demo implements CommandLineRunner {
    ...
    @Autowired
    public Demo(final StringRedisTemplate template, final SlowService service) {
